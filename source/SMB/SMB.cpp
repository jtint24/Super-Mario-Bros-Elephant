...
GetPlayerColors:
    ...
    // 0x0a - pretty good! White skin, red/black clothes
...
UpToSuper:
    ...
    writeData(PlayerStatus, a);
    JSR(GetPlayerColors, 593); // change player's palette if necessary
...
ChkForPlayerInjury:
    ...
    player_state = M(PlayerStatus);
    aspeed = M(Player_XSpeedAbsolute);
    
    if (aspeed >= 0x28 && player_state) {
        goto EnemyStomped;
    }
...
Return:
    ...
    case 592:
        goto Return_592;
    case 593:
        goto Return_593; // This one's just for me ^.^
    }
}
